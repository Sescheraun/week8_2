...
public interface TemperatureConversionsSoapType {
    ...
    @RequestWrapper(localName = "CelsiusToFahrenheit", targetNamespace = "http://webservices.daehosting.com/temperature", className = "temp.CelsiusToFahrenheit")
    @ResponseWrapper(localName = "CelsiusToFahrenheitResponse", targetNamespace = "http://webservices.daehosting.com/temperature", className = "temp.CelsiusToFahrenheitResponse")
    ...
    @RequestWrapper(localName = "FahrenheitToCelsius", targetNamespace = "http://webservices.daehosting.com/temperature", className = "temp.FahrenheitToCelsius")
    @ResponseWrapper(localName = "FahrenheitToCelsiusResponse", targetNamespace = "http://webservices.daehosting.com/temperature", className = "temp.FahrenheitToCelsiusResponse")
    ...
    @RequestWrapper(localName = "WindChillInCelsius", targetNamespace = "http://webservices.daehosting.com/temperature", className = "temp.WindChillInCelsius")
    @ResponseWrapper(localName = "WindChillInCelsiusResponse", targetNamespace = "http://webservices.daehosting.com/temperature", className = "temp.WindChillInCelsiusResponse")
    ...
    @RequestWrapper(localName = "WindChillInFahrenheit", targetNamespace = "http://webservices.daehosting.com/temperature", className = "temp.WindChillInFahrenheit")
    @ResponseWrapper(localName = "WindChillInFahrenheitResponse", targetNamespace = "http://webservices.daehosting.com/temperature", className = "temp.WindChillInFahrenheitResponse")
